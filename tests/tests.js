describe('getCardImageUrl', function () {
  ...
  it('works for 2 - 10', function () {
    expect(getCardImageUrl({ point: 2, suit: 'diamonds' }))
      .toEqual('images/2_of_diamonds.png');
    expect(getCardImageUrl({ point: 3, suit: 'diamonds' }))
      .toEqual('images/3_of_diamonds.png');
    expect(getCardImageUrl({ point: 4, suit: 'diamonds' }))
      .toEqual('images/4_of_diamonds.png');
  });
  ...
  it('should work for different suit', function() {
    ...
    expect(getCardImageUrl({ point: 13, suit: 'hearts' }))
      .toEqual('images/king_of_hearts.png');
